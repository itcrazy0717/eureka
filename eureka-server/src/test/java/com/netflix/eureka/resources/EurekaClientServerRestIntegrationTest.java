...
public class EurekaClientServerRestIntegrationTest {
	...
	private static void startServer() throws Exception {
		...
		String resBasePath = new File("src/main/resources").getAbsolutePath();
		webAppCtx.setResourceBase(resBasePath);
		String webXmlPath = new File("src/main/webapp/WEB-INF/web.xml").getAbsolutePath();
		webAppCtx.setDescriptor(webXmlPath);
	...
	private static void createEurekaServerConfig() {
		...
		when(eurekaServerConfig.shouldBatchReplication()).thenReturn(false);
